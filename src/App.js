...
import CardSuperhero from './components/CardSuperhero'
...
function App() {
  return (
    <>
        <h1 className="header">Ликбез по комиксам: всё, что надо знать о 10 крутейших супергероях</h1>
        <div className="container">
          <Row xs={1} sm={6} md={6} lg={4} xl={4} className="justify-content-center">
            {
